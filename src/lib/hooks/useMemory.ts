...
const MEMORY_COUNT_PER_RECALL = 2
...
export const useMemory = create<Memory>()((setState, getState) => ({
  ...
  getMemoryByDescription: async (vector, description, count = MEMORY_COUNT_PER_RECALL) => {
